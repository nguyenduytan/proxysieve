ALTER TABLE traffic_events ADD COLUMN policy_id TEXT;
ALTER TABLE traffic_events ADD COLUMN rule_id TEXT;
CREATE INDEX traffic_events_policy_rule_at ON traffic_events(policy_id, rule_id, at DESC);
...
ALTER TABLE traffic_aggregates_minute RENAME TO traffic_aggregates_minute_v17;
ALTER TABLE traffic_aggregates_hour RENAME TO traffic_aggregates_hour_v17;
ALTER TABLE traffic_aggregates_day RENAME TO traffic_aggregates_day_v17;
ALTER TABLE traffic_cost_aggregates_minute RENAME TO traffic_cost_aggregates_minute_v17;
ALTER TABLE traffic_cost_aggregates_hour RENAME TO traffic_cost_aggregates_hour_v17;
ALTER TABLE traffic_cost_aggregates_day RENAME TO traffic_cost_aggregates_day_v17;
...
CREATE TABLE traffic_aggregates_minute (
    ...
    policy_id TEXT NOT NULL, rule_id TEXT NOT NULL,
    ...
    PRIMARY KEY (bucket_start, action, protocol, client_id, pool_id, proxy_id, chain_id, policy_id, rule_id)
) STRICT;
...
INSERT INTO traffic_aggregates_minute SELECT bucket_start,action,protocol,client_id,pool_id,proxy_id,chain_id,'','',request_count,client_upload,client_download,upstream_upload,upstream_download,direct_bytes,cache_served,health_check,estimated_avoided FROM traffic_aggregates_minute_v17;
INSERT INTO traffic_aggregates_hour SELECT bucket_start,action,protocol,client_id,pool_id,proxy_id,chain_id,'','',request_count,client_upload,client_download,upstream_upload,upstream_download,direct_bytes,cache_served,health_check,estimated_avoided FROM traffic_aggregates_hour_v17;
INSERT INTO traffic_aggregates_day SELECT bucket_start,action,protocol,client_id,pool_id,proxy_id,chain_id,'','',request_count,client_upload,client_download,upstream_upload,upstream_download,direct_bytes,cache_served,health_check,estimated_avoided FROM traffic_aggregates_day_v17;
...
CREATE TABLE traffic_cost_aggregates_minute (
    ...
    PRIMARY KEY (bucket_start, action, protocol, client_id, pool_id, proxy_id, chain_id, policy_id, rule_id, currency)
) STRICT;
...
INSERT INTO traffic_cost_aggregates_minute SELECT bucket_start,action,protocol,client_id,pool_id,proxy_id,chain_id,'','',currency,configured_cost_micros,priced_upstream_upload,priced_upstream_download FROM traffic_cost_aggregates_minute_v17;
INSERT INTO traffic_cost_aggregates_hour SELECT bucket_start,action,protocol,client_id,pool_id,proxy_id,chain_id,'','',currency,configured_cost_micros,priced_upstream_upload,priced_upstream_download FROM traffic_cost_aggregates_hour_v17;
INSERT INTO traffic_cost_aggregates_day SELECT bucket_start,action,protocol,client_id,pool_id,proxy_id,chain_id,'','',currency,configured_cost_micros,priced_upstream_upload,priced_upstream_download FROM traffic_cost_aggregates_day_v17;

DROP TABLE traffic_aggregates_minute_v17;
DROP TABLE traffic_aggregates_hour_v17;
DROP TABLE traffic_aggregates_day_v17;
DROP TABLE traffic_cost_aggregates_minute_v17;
DROP TABLE traffic_cost_aggregates_hour_v17;
DROP TABLE traffic_cost_aggregates_day_v17;
